...
export default function BlockEmailsLine(props) {
    const { ...rest } = props;

    const lineChartDataBlockedEmails = [
        {
      ...
      const lineChartOptionsBlockedEmails = {
        chart: {
          toolbar: {
            show: false,
          },
            ...
            <Flex align='center'>
              ...
              <Text color='green.500' fontSize='md' fontWeight='700'>
                ...
                <Box minH='260px' minW='100%' mt='auto'>
                    <LineChart
                        chartData={lineChartDataBlockedEmails}
                        chartOptions={lineChartOptionsBlockedEmails}
                    />
                </Box>
            </Flex>
        </Card>
