...
// import { pieChartDataDMARCCheck, pieChartOptionsDMARCCheck } from "variables/charts";
import { VSeparator } from "components/separator/Separator";
import React from "react";

export default function DMARCCheckPie(props) {
    const { ...rest } = props;

    const pieChartDataDMARCCheck = [34, 33, 33];
    const pieChartOptionsDMARCCheck = {
        ...
        <Card p='20px' align='center' w='100%' {...rest} h="300px" boxShadow={cardShadow} >
          ...
          <option value='yearly'>Yearly</option>
            ...
            <PieChart
                h='100%'
                w='100%'
                chartData={pieChartDataDMARCCheck}
                chartOptions={pieChartOptionsDMARCCheck}
            />
            {/* <Card
                bg={cardColor}
                flexDirection='row'
