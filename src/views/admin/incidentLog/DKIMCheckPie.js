...
export default function DKIMCheckPie(props) {
    const { ...rest } = props;

    const pieChartDataDKIMCheck = [42, 33, 25];

    const pieChartOptionsDKIMCheck = {
        ...
        <Card p='20px' align='center' w='100%' {...rest} h="300px" boxShadow={cardShadow} >
          ...
          <option value='yearly'>Yearly</option>
            ...
            <PieChart
                h='100%'
                w='100%'
                chartData={pieChartDataDKIMCheck}
                chartOptions={pieChartOptionsDKIMCheck}
            />
            {/* <Card
                bg={cardColor}
                flexDirection='row'
