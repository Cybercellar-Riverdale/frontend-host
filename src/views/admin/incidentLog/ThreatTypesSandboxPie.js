...
// import { pieChartDataThreatTypeSandBox, pieChartOptionsThreatTypeSandBox } from "variables/charts";
import { VSeparator } from "components/separator/Separator";
import React from "react";

export default function ThreatTypesSandboxPie(props) {
    const { ...rest } = props;
    const pieChartDataThreatTypeSandBox = [37.5, 23.5, 39.0];
    const pieChartOptionsThreatTypeSandBox = {
        ...
        <Card p='20px' align='center' w='100%' {...rest} h="300px" boxShadow={cardShadow} >
          ...
          <option value='yearly'>Yearly</option>
            ...
            <PieChart
                h='100%'
                w='100%'
                chartData={pieChartDataThreatTypeSandBox}
                chartOptions={pieChartOptionsThreatTypeSandBox}
            />
            {/* <Card
                bg={cardColor}
                flexDirection='row'
